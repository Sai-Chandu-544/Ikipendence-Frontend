...
<Route
  ...
  <>
    <div >
     <p className="font-bold text-white desktop:text-5xl  bg-[#7A5CFA] desktop:pb-5 mobile:pb-5 desktop:pl-5 desktop:pt-10  mobile:text-2xl  mobile:pt-8 mobile:pl-5">Sthaniya</p>
       <div className="h-[100vh]  bg-[#7A5CFA]">
  <InfiniteMenu items={items} />
      ...
      <Route
        path="/home"
        element={
          <div className="desktop:h-screen desktop:w-screen bg-[#E27D60] mobile:h-screen mobile:w-screen">
            <div>
              <p className="font-bold text-white desktop:text-5xl desktop:ml-10 desktop:pt-10 mobile:text-[15px] mobile:ml-5 mobile:pt-5">Sthaniya</p>
              <p className="font-[sans-serif] font-semibold text-white desktop:text-4xl text-center desktop:mt-10 mobile:text-[12px] mobile:pl-20 mobile:mt-5">
